...
namespace
{
  ...
  const Command COMMANDS[] = {{"anons", karpovich::cmdAnons},
                              {"deanon", karpovich::cmdDeanon},
                              {"redesc", karpovich::cmdRedesc},
                              {"desc", karpovich::cmdDesc},
                              {"meet", karpovich::cmdMeets},
                              {"meets", karpovich::cmdMeets},
                              {"commons", karpovich::cmdCommons},
                              {"common", karpovich::cmdCommons},
                              {"less", karpovich::cmdLess},
                              {"greater", karpovich::cmdGreater},
                              {"out-persons", karpovich::cmdOutPersons}};
